...
class BelongsToMany extends EloquentBelongsToMany
{
    ...
    public function match(array $models, Collection $results, $relation)
    {
        ...
        foreach ($models as $model) {
            $key = $this->getQuery()->objectIdToString((!empty($this->self_key) ? $model->getAttribute($this->self_key) : $model->getKey()));
    ...
    protected function buildDictionary(Collection $results)
    {
        ...
        foreach ($results as $result) {
            foreach ($result->$foreign as $item) {
                $dictionary[$this->getQuery()->objectIdToString($item)][] = $result;
            }
        }
    ...
    protected function getKeys(array $models, $key = null)
    {
        return collect($models)->map(function ($value) use ($key) {
            return $this->getQuery()->objectIdToString($key ? $value->getAttribute($key) : $value->getKey());
