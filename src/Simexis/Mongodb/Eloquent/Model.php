...
use Simexis\Mongodb\Query\Builder as QueryBuilder;
...
abstract class Model extends BaseModel
{
    ...
    public function getIdAttribute($value = null)
    {
        ...
        return $this->newBaseQueryBuilder()->objectIdToString($value);
    }
    ...
    public function attributesToArray()
    {
        ...
        foreach ($attributes as $key => &$value) {
            $value = $this->newBaseQueryBuilder()->objectIdToString($value);
        }
    ...
    protected function pullAttributeValues($column, array $values)
    {
        ...
        if (is_array($current)) {
            foreach ($values as $value) {
                $keys = array_keys($current, $this->newBaseQueryBuilder()->objectIdToString($value));
